...
if OB == "False":
    ...
    if OEP == "False":
        ...
        Enemy5 = enemy("assets/Enemy5.png", 448, 320, 32, True)
    elif OEP == "True":
        ...
        Enemy5 = enemy("assets/Enemy5P.png", 448, 224, 32, True)
    else:
        Enemy = enemy("assets/Enemy.png", 128, 128, 32, False)
        Enemy1 = enemy("assets/Enemy1.png", 320, 320, 32, False)
        Enemy2 = enemy("assets/Enemy2.png", 320, 128, 32, True)
    ...
    if PlayerBUG == 1:
        ...
        PlayerSuper = player("assets/Enemy5P.png", 900, 900, 32, True)
    if EnemyBUG == 1:
        Enemy = enemy("assets/Enemy3P.png", 128, 128, 32, False)
        Enemy1 = enemy("assets/Enemy5.png", 320, 320, 32, False)
        ...
        Enemy5 = enemy("assets/PlayerP.png", 448, 320, 32, True)
    elif EnemyBUG == 2:
